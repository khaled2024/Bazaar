...
final class FilterView: UIView {
    ...
    private var filterTitleLabel = CustomLabel(text: "Sort & Filter", numberOfLines: 0, font:FiraSana.bold.rawValue, size: 20, textColor: .black, textAlignment: .center)
    private var seperatorView = CustomView(backgroundColor: .systemGray5)
    private var collectionTitlLabel = CustomLabel(text: "Categories", numberOfLines: 0, font: FiraSana.bold.rawValue, size: 17, textColor: .black, textAlignment: .left)
